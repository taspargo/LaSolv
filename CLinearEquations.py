...
import sympy
import Support
from sympy import factor, init_printing, zeros, degree
import Reorder
...
class CLinearEquations(object):
    ...
    def calculateSolution(self, circuit):
        ...
        top = circuit.calculateVorIEqn(self.iColumn, circuit.getOutputSource())
        if Support.gVerbose > 1:
            print(Support.myName(), ': Calculating input source equation')
        bottom = circuit.calculateVorIEqn(self.iColumn, circuit.getInputSource())
